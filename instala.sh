...
echo -e "${cor[1]}=?=?=?=?=?=?=?=?=?=?=?=?=?=?=?=?=?=?=?=?=?=?=?=?=?=?"
echo -e "${cor[3]} $(source trans -b pt:${id} "Iniciando Instalacao...")"
echo -e "${cor[1]}=?=?=?=?=?=?=?=?=?=?=?=?=?=?=?=?=?=?=?=?=?=?=?=?=?=?"
echo -ne "${cor[4]}"
echo -ne "${cor[4]}"
wget -O lista https://notabug.org/bicutaa/ichigo/raw/master/lista -o /dev/null
valid_fun